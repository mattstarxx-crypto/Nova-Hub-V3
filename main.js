  ...
  if (filtered.length === 0) {
    ...
    filtered.forEach(g => {
      ...
      card.innerHTML    = `
        ...
        ${g.img
          ? `<div class="card-thumb"><img src="${g.img}" alt="${g.title}"></div>`
